-- CreateEnum
CREATE TYPE "FieldType" AS ENUM ('text', 'number', 'positiveNumber', 'negativeNumber', 'literal');
...
-- AddForeignKey
ALTER TABLE "Field" ADD CONSTRAINT "Field_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

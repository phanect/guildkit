  ...
  return (
    <div className="w-full max-w-4xl px-9">
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 mb-3 text-lg font-bold text-gray-900 hover:text-gray-700"
      >
        <Image src="/vendor/octicons/organization.svg" alt="Employer" title="Employer" width="18" />
        {job.employer.name}
      </Link>
      <div className="mb-6">
